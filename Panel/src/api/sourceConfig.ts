/**
 * DustWatch Panel — Data Source Configuration
 *
...
export function getApiBaseUrl(): string {
  ...
  if (src === 'local') {
    raw = !isPlaceholder(envApiUrl) ? envApiUrl : localFallback.api;
  } else if (src === 'remote') {
    raw = !isPlaceholder(envRemoteApiUrl) ? envRemoteApiUrl : remoteFallback.api;
  } else {
    raw = getCustomUrls().apiUrl || remoteFallback.api;
  }
